...
public class CommodityController {
    ...
    @Log(moudle = "运单管理",type = BusincessType.INSERT)
    ...
    @Log(moudle = "运单管理",type = BusincessType.DELETE)
    ...
    @Log(moudle = "运单管理",type = BusincessType.UPDATE)
    ...
    @Log(moudle = "运单管理",type = BusincessType.QUERY)
    @GetMapping("")
    ...
    public List<Commodity> findAllByTracking(@PathVariable String tracking) {
        return commodityService.findAllByTracking(tracking);
    }
